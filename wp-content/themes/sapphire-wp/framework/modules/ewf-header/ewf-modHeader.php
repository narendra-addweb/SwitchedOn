...
{ 
	...
	function meta_update(){
			...
			if (array_key_exists('_ewf_modHeader_title', $_POST)){
				$post_modHeader_settings['title'] = base64_encode($_POST['_ewf_modHeader_title']).'*';
			}
			...
			if (array_key_exists('_ewf_modHeader_description', $_POST)){
				$post_modHeader_settings['description'] = base64_encode($_POST['_ewf_modHeader_description']);
			}
			...
			// echo '<pre>';
				// print_r($_POST);
				// print_r($post_modHeader_settings);
			// echo '</pre>';
		...
		function get_postSettings($post_id = 0){
			...
			$post_modHeader_settings['title'] = base64_decode($post_modHeader_settings['title']);
			$post_modHeader_settings['description'] = base64_decode($post_modHeader_settings['description']);
